...
public class MyJavaTypeResolverImpl implements JavaTypeResolver {
  ...
  public MyJavaTypeResolverImpl() {
    ...
    // JDK 1.8 types
    typeMap
        .put(TIME_WITH_TIMEZONE, new JavaTypeResolverDefaultImpl.JdbcTypeInformation("TIME_WITH_TIMEZONE", //$NON-NLS-1$
            new FullyQualifiedJavaType("java.time.OffsetTime"))); //$NON-NLS-1$
    typeMap.put(TIMESTAMP_WITH_TIMEZONE,
        new JavaTypeResolverDefaultImpl.JdbcTypeInformation("TIMESTAMP_WITH_TIMEZONE", //$NON-NLS-1$
