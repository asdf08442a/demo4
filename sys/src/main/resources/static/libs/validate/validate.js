...
function doValidForm(formId, language) {
  ...
  var flag = true;
  /*必填*/
  $(formId).find("input[require]:visible,textarea[require]:visible").each(
      function () {
        position = setPosition(this);
        var messageRequire = (typeof($(this).attr("data-require"))
            != "undefined") ? $(this).attr("data-require") : dataRequire;
        if ("" == $(this).val().trim()) {
          $(this).addClass("error");
          $(this).addClass("prominput");
          flag = false;
          $(this).after('<span  class="active promimg fa fa-exclamation-circle '
              + position
              + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="'
              + messageRequire + '"></span>');
  ...
  $(formId).find("select[require]:visible").each(function () {
    position = setPosition(this);
    var messageRequire = (typeof($(this).attr("data-require")) != "undefined")
        ? $(this).attr("data-require") : dataRequire;
    if ("-1" == $(this).val().trim() || "0" == $(this).val().trim() || "" == $(
        this).val().trim()) {
      $(this).addClass("error");
      $(this).addClass("prombtn");
      flag = false;
      $(this).after(
          '<span  class="active promimg fa fa-exclamation-circle ' + position
          + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="'
          + messageRequire + '"></span>');
  ...
  $(formId).find("input[max]:visible,textarea[max]:visible").each(function () {
    position = setPosition(this);
    var messageMax = (typeof($(this).attr("data-max")) != "undefined") ? $(
        this).attr("data-max") : dataMax;
  ...
  $(formId).find("input[min]:visible").each(function () {
    ...
    var messageMin = (typeof($(this).attr("data-min")) != "undefined") ? $(
        this).attr("data-min") : dataMin;
    if ($(this).val().length < le) {
      $(this).addClass("error");
      flag = false;
      $(this).addClass("prominput");
  ...
  $(formId).find("input[fax]:visible").each(function () {
    position = setPosition(this);
    var messageFax = (typeof($(this).attr("data-fax")) != "undefined") ? $(
        this).attr("data-fax") : dataFax;
  ...
  $(formId).find("input[contact]:visible").each(function () {
    position = setPosition(this);
    var messageContact = (typeof($(this).attr("data-contact")) != "undefined")
        ? $(this).attr("data-contact") : dataContact;
    if (isNotNull($(this).val()) && !isFax($(this).val())) {
      $(this).addClass("error");
      flag = false;
      $(this).addClass("prominput");
  ...
  $(formId).find("input[plusinteger]:visible").each(function () {
    position = setPosition(this);
    var messagePositiveInteger = (typeof($(this).attr("data-positiveInteger"))
        != "undefined") ? $(this).attr("data-positiveInteger")
        : dataPositiveInteger;
  ...
  $(formId).find("input[number]:visible").each(function () {
    position = setPosition(this);
    var messageNumber = (typeof($(this).attr("data-number")) != "undefined")
  ...
  $(formId).find("input[email]:visible").each(function () {
    position = setPosition(this);
    var messageEmail = (typeof($(this).attr("data-email")) != "undefined") ? $(
        this).attr("data-email") : dataEmail;
  ...
  /*禁止输入html标签*/
  $(formId).find("input[nohtml]:visible,textarea[nohtml]:visible").each(
      function () {
        position = setPosition(this);
        var messageNohtml = (typeof($(this).attr("data-nohtml")) != "undefined")
            ? $(this).attr("data-nohtml") : dataNohtml;
  ...
  if (rdos.size() > 0) {
    $(rdos).each(function (index, dom) {
      ...
      if (preName != name) {
        preName = name;
        if ($(formId).find(
            "input[type = radio][name ='" + name + "']:checked").size() == 0) {
          var lst = $(formId).find(
              "input[type = radio][name ='" + name + "']:last");
          $(lst).addClass("error");
          $(this).addClass("prominput");
          flag = false;
          $(lst).after(
              '<span  class="active promimg fa fa-exclamation-circle" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="'
              + dataRequire + '"></span>');
        }
      }
    });
    ...
    $(rdos).each(function (index, dom) {
      ...
      if (preName != name) {
        ...
        if ($(formId).find(
            ...
            == 0) {
          var lst = $(formId).find(
              "input[type = checkBox][name ='" + name + "']:last");
          $(lst).addClass("error");
          $(this).addClass("prominput");
          flag = false;
          $(lst).after(
  ...
  $(formId).find("input[numericLetters]:visible").each(function () {
    position = setPosition(this);
    var messageNumericLetters = (typeof($(this).attr("data-numericLetters"))
        != "undefined") ? $(this).attr("data-numericLetters")
        : dataNumericLetters;
  ...
  $(formId).find("input[alphanumeric]:visible").each(function () {
    position = setPosition(this);
    var messageAlphanumeric = (typeof($(this).attr("data-alphanumeric"))
        != "undefined") ? $(this).attr("data-alphanumeric") : dataAlphanumeric;
    var alp = $(this).val().trim();
  ...
  $(formId).find("input[nochinese]:visible").each(function () {
    position = setPosition(this);
    var messageNochinese = (typeof($(this).attr("data-nochinese"))
        != "undefined") ? $(this).attr("data-nochinese") : dataNochinese;
    var alp = $(this).val().trim();
    var patrn = /^[^\u4e00-\u9fa5]+$/;//无中文匹配
    if (alp != "" && !patrn.exec(alp)) {
      $(this).addClass("error");
  ...
  $(formId).find("input[chinese]:visible").each(function () {
    position = setPosition(this);
    var messageChinese = (typeof($(this).attr("data-chinese")) != "undefined")
        ? $(this).attr("data-chinese") : dataChinese;
    var alp = $(this).val().trim();
    var patrn = /^[\u4e00-\u9fa5]+$/;//全中文匹配
    if (!patrn.exec(alp)) {
      $(this).addClass("error");
  ...
  $(formId).find("input[onlyEnglish]:visible").each(function () {
    position = setPosition(this);
    var messageEnglish = (typeof($(this).attr("data-english")) != "undefined")
        ? $(this).attr("data-english") : dataEnglish;
    var alp = $(this).val().trim();
    var patrn = /[\u4e00-\u9fa5]+/;//全英文匹配
    if (patrn.test(alp)) {
      $(this).addClass("error");
  ...
  $(formId).find("input[noLetterChinese]:visible").each(function () {
    position = setPosition(this);
    var messageNoLetterChinese = (typeof($(this).attr("data-noLetterChinese"))
        != "undefined") ? $(this).attr("data-noLetterChinese")
        : dataNoLetterChinese;
    var alp = $(this).val().trim();
    ...
    if (alp.length > 0 && !patrn.test(alp)) {
      ...
      $(this).after(
          '<span  class="active promimg fa fa-exclamation-circle ' + position
          + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="'
          + messageNoLetterChinese + '"></span>');
    }
  });
  /*只能输入数字、字母和中文*/
  $(formId).find("input[digitalAlphabetChinese]:visible").each(function () {
    position = setPosition(this);
    var messageDigitalAlphabetChinese = (typeof($(this).attr(
        "data-digitalAlphabetChinese")) != "undefined") ? $(this).attr(
        "data-digitalAlphabetChinese") : dataDigitalAlphabetChinese;
    var alp = $(this).val().trim();
    ...
    if (alp != "" && !patrn.exec(alp)) {
      ...
      $(this).after(
          '<span  class="active promimg fa fa-exclamation-circle ' + position
          + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="'
          + messageDigitalAlphabetChinese + '"></span>');
    }
  });
  /*只能输入数字、字母、中文和空格*/
  $(formId).find("input[digitalAlphabetChineseBlank]:visible").each(
      function () {
        position = setPosition(this);
        var messageDigitalAlphabetChineseBlank = (typeof($(this).attr(
            "data-digitalAlphabetChineseBlank")) != "undefined") ? $(this).attr(
            "data-digitalAlphabetChineseBlank")
            : dataDigitalAlphabetChineseBlank;
        var alp = $(this).val().trim();
        var patrn = /^[a-zA-Z0-9\u4e00-\u9fa5 ]+$/
        if (alp != "" && !patrn.exec(alp)) {
          $(this).addClass("error");
          ...
          $(this).after('<span  class="active promimg fa fa-exclamation-circle '
              + position
              + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="'
              + messageDigitalAlphabetChineseBlank + '"></span>');
        }
      });

  /*固定长度*/
  $(formId).find("input[length]:visible,textarea[length]:visible").each(
      function () {
        if ($(this).val() != "") {
          position = setPosition(this);
          var messageLength = (typeof($(this).attr("data-length"))
              != "undefined") ? $(this).attr("data-length") : dataLength;
          ...
          if ($(this).val().length != le) {
            ...
            $(this).addClass("prominput");
            $(this).after(
                '<span  class="active promimg fa fa-exclamation-circle '
                + position
                + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="'
                + messageLength + le + '"></span>');
          }
        }
      });
  ...
  $(formId).find("input[money]:visible").each(function () {
    position = setPosition(this);
    var messageRequire = (typeof($(this).attr("data-money")) != "undefined")
        ? $(this).attr("data-money") : dataMoney;
    var alp = $(this).val().trim();
    var patrn = /^d*(?:.d{0,2})?$/;
  ...
  $(formId).find('.end_date').each(function () {
    ...
    if (dateAfter < dateBefore) {
      ...
      $(this).after(
          '<span  class="active promimg fa fa-exclamation-circle ' + position
          + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="结束时间不能小于开始时间"></span>');
    }
  });
  ...
  $(formId).find('.pwdCheck').each(function () {
    ...
    if (!isCorrectPWD(password) || !isCorrectPWD(confirmPassword)) {
      ...
      $(this).after(
          '<span  class="active promimg fa fa-exclamation-circle ' + position
          + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Password must consist of 6 to 16 letters, Numbers"></span>');
    }
    var alp = $(this).val().trim();
    var patrn = /^[^\u4e00-\u9fa5]+$/;//无中文匹配
    if (!patrn.exec(alp)) {
    ...
    if (password != confirmPassword) {
      ...
      $(this).after(
          '<span  class="active promimg fa fa-exclamation-circle ' + position
          + '" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="The two passwords you typed do not match"></span>');
    }
