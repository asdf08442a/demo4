    ...
    if (childArry.length > 0) {
      ...
      for (var i in childArry) {
        ...
        if (childArryChild.length > 0) {
          menus += '<li class="treeview"><a href="#"><i class="'
              + childArry[i].icon + '"></i> <span>' + childArry[i].name
              + '</span>'
              + '<span class="pull-right-container">'
              + '<i class="fa fa-angle-left pull-right"></i>'
              + '</span></a>'
        } else {
          menus += '<li><a href="#' + childArry[i].url.substring(1,
              childArry[i].url.length) + '"><i class="' + childArry[i].icon
              + '"></i><span>' + childArry[i].name + '</span></a>';
        }
